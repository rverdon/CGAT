...
Genomics research attempts to understand information maintained in the genomes
of various organisms. A \textit{genome} is a sequence of DNA containing all
information for an organism. Genomes contain several types of regions,
\textit{exons}, \textit{introns}, \textit{CDS}s,   In order to link biological information of the organism
to genomic information in the DNA sequence... to  To understand this information, it
\cite{annotation}
...
\begin{itemize}
\item administration_info - Provides the user with meta information information that the user would need to perform administrative tasks such as creating a group or assigning a task.
...
\item submit_annotation - Submit a finalized annotation.
\item upload_contig - Upload a contig into CGAT.
\end{itemize}
